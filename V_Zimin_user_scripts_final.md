...
* В текстовый канал сервера выводится информация о матче, о строениях и всех героях. Ниже рассматриваются возвращаемые значения, при запросе информации о финале турнира The International 2019 (ID матча - 4986461644)

![Пример](https://github.com/megadybina/itproekt/blob/master/resources/matchinfo(general).png)
...
![Пример](https://github.com/megadybina/itproekt/blob/master/resources/matchinfo(player).png)
...
![Пример](https://github.com/megadybina/itproekt/blob/master/resources/map4986461644.png)
